                                ...
                                <div class="p-5">
                                    ...
                                    <form action="../controller/loginUser.php" method="POST" class="user">
                                        <div class="form-group">
                                            <input name="email" 
                                            value="<?= isset($_SESSION['form_errors']['email']) ? $_SESSION['form_errors']['email'] : ''?>"
                                            type="email" class="form-control form-control-user"
                                            id="exampleInputEmail" id="exampleInputEmail" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            <input name="password" 
                                            value="<?= isset($_SESSION['form_errors']['password']) ? $_SESSION['form_errors']['password'] : ''?>"
